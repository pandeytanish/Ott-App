...
import ComedyApi from '../Category API/ComedyApi'
import { useState } from 'react';

function Comedy() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const dataLength = ComedyApi.length;
  ...
  return (
    <div >
 <h1 className='text-white font-extrabold text-2xl  ml-14 mt-[50px]'>Comedy Movies</h1>
    <div className='h-[200px] w-[95%] ml-[50px]  flex gap-2 '>
    {ComedyApi.slice(currentIndex, currentIndex + 6).map((value,index) =>
