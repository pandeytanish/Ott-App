...
import LastYearApi from '../Category API/LastYearApi'
import { useState } from 'react';

function LestYear() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const dataLength = LastYearApi.length;
  ...
  return (
    <div >
  <h1 className='text-white font-extrabold text-2xl  ml-14 mt-[50px]'>Last Year Movies</h1>
    <div className='h-[200px] w-[95%] ml-[50px]  flex gap-2 '>
    {LastYearApi.slice(currentIndex, currentIndex + 6).map((value,index) =>
