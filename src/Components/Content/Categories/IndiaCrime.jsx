...
import IndianCrime from '../Category API/IndianCrime'
import { useState } from 'react';


function IndiaCrime() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const dataLength = IndianCrime.length;
  ...
  return (
    <div >
<h1 className='text-white font-extrabold text-2xl  ml-14 mt-[50px]'>Indian Crime Movies </h1>
    ...
    {IndianCrime.slice(currentIndex, currentIndex + 6).map((value,index) =>
