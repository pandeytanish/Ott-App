...
import HorroApi from '../Category API/HorroApi'
import { useState } from 'react';

function Horro() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const dataLength = HorroApi.length;
  ...
  return (
    <div >
    <h1 className='text-white font-extrabold text-2xl  ml-14 mt-[50px]'>Horror Movies </h1>
    ...
    {HorroApi.slice(currentIndex, currentIndex + 6).map((value,index) =>
